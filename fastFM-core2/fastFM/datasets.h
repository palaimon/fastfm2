//
// Created by ibayer on 31.07.17.
//

#ifndef FASTFM_DATASETS_H
#define FASTFM_DATASETS_H
...
public:
    ...
    Vector y_class(double noise_stddev=0.0, double flip_proba=0.1, double class_ratio=0.5);
...
public:
    RecDataGenerator(int n_context=50, int n_item=100, int rank=2, int n_context_features=100, int n_item_features=200,
                     int n_active_features=5, std::vector<double> stddev={2, 3}, int rng_seed=123);
